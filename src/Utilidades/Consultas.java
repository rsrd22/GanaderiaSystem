...
public class Consultas {
    ...
    public static void Agregar() {
        ...
        consultas.put("BUSQUEDA_GRUPOS", "SELECT\n"
                + "a.id ID,\n"
                + "a.id_tipo_animal ID_TIPO_ANIMAL,\n"
                + "c.descripcion DES_TIPO_ANIMAL, \n"
                + "a.descripcion DESCRIPCION,\n"
                + "a.estado ESTADO,\n"
                + "IFNULL(a.id_macrogrupo, '')  ID_MACRO_GRUPO,\n"
                + "IFNULL(b.descripcion, '') DES_MACRO_GRUPO,\n"
                + "a.fecha FECHA,\n"
                + "a.id_usuario ID_USUARIO,\n"
                + "d.id ID_FINCA,\n"
                + "d.descripcion DES_FINCA\n"
                + "FROM grupos a\n"
        ...
        consultas.put("BUSQUEDA_ANIMALES", "SELECT\n"
                + "a.id ID,\n"
                + "a.id_tipo_animal ID_TIPO_ANIMAL,\n"
                + "b.descripcion DES_TIPO_ANIMAL,\n"
                + "a.numero NUMERO,\n"
                + "a.numero_mama NUMERO_MAMA,\n"
                + "a.genero GENERO,\n"
                + "a.calificacion CALIFICACION,\n"
                + "a.notas NOTAS,\n"
                + "a.fecha_destete FECHA_DESTETE,\n"
                + "a.capado CAPADO,\n"
                + "a.fecha_nacimiento FECHA_NACIMIENTO,\n"
                + "a.fecha_muerte FECHA_MUERTE,\n"
                + "a.fecha FECHA,\n"
                + "a.id_usuario ID_USUARIO,\n"
                + "a.peso PESO\n"
                + "FROM \n"
        ...
        consultas.put("CARGAR_COMBO_PROPIETARIOS", "SELECT\n"
                ...
                + "	CONCAT(\n"
                + "		TRIM(\n"
                + "			CONCAT(primer_nombre,' ',segundo_nombre)\n"
                + "		),\n"
                + "		' ',\n"
                + "		TRIM(\n"
                + "			CONCAT(primer_apellido,' ',segundo_apellido)\n"
                + "		)\n"
                + "	)\n"
                + ") descripcion\n"
                + "FROM propietarios");
