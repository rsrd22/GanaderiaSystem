...
public class ControlGrupos implements IControl {
    ...
    public int Guardar(Object _grupo) {
        ...
        consultas.add(
                ...
                "INSERT INTO grupos(id,id_tipo_animal,descripcion,estado,id_macrogrupo,fecha,id_usuario,pesable,palpable,tipo_grupo) VALUES(\n"
                + "0,\n"
