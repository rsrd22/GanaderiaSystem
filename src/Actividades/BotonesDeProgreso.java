 ...
 * @author DOLFHANDLER
 */
public class BotonesDeProgreso extends Rectangulo implements IGraficos {

    private FontMetrics fm;
    private int id;
    private String texto;

    public BotonesDeProgreso(int id, String texto, int x, int y, int ancho, int alto, Color colorFondo, Color colorTexto) {
