...
public class VistaHistoricoVentas extends javax.swing.JPanel {
    ...
    public VistaHistoricoVentas() {
        ...
        //<editor-fold defaultstate="collapsed" desc="ORDEN TABLA">
            ...
            NameColumnasOrden.add("tipo_venta");
            NameColumnasOrden.add("fecha_venta");
            NameColumnasOrden.add("peso");
            NameColumnasOrden.add("peso_canal");
            NameColumnasOrden.add("PORC");
            NameColumnasOrden.add("precio_venta");
            NameColumnasOrden.add("VVENTA");
//</editor-fold>
...
//            }
    ...
    public void cargarHistoricoVentas() {
        String consulta = consultas.get("OBTENER_HISTORICO_VENTAS").replace("PARAMETRO1", txtCodigoTipoAnimal.getText()).replace("ORDEN", Orden);
