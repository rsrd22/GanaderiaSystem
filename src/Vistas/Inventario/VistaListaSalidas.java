 ...
 * @author DOLFHANDLER
 */
public class VistaListaSalidas extends javax.swing.JPanel {
    ...
    private List<Map<String, String>> listaSalidas;
    private ControlInventario controlInventario;
    private String descProducto;
    
    public VistaListaSalidas() {
        initComponents();
    }

    public VistaListaSalidas(ModeloVentanaGeneral modeloVista) {
        initComponents();
        setSize(400, 400);
...
//</editor-fold>
    ...
    private void InicializarTablaSalidas() {
    ...
    private void cargarTablaSalidas() {
        txtEncabezado.setText("<html>"
                + "<p>Listado de salidas del producto "
                + "<b>" + descProducto + "</b>"
                + "</p>"
                + "</html>");
        listaSalidas = (List<Map<String, String>>) controlInventario.ObtenerSalidas(idFinca, id_producto);
    ...
    private void MostrarTabla() {
        ...
        for (int i = 0; i < listaSalidas.size(); i++) {
            Utilidades.agregarFilaTabla(
                    ...
                    new Object[]{
                        (i + 1),//consecutivo,
                        listaSalidas.get(i).get("FECHA"),
                        Utilidades.setFormatoNumerico(listaSalidas.get(i).get("CANTIDAD")),
                        Utilidades.decodificarElemento(listaSalidas.get(i).get("OBSERVACION"))
                    }
            );
        }
    }
